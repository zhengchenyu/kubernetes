...
import (
	...
	cnat1v1alpha1 "k8s.io/kubernetes/api/v1alpha1"
)

// At1Reconciler reconciles a At1 object
type At1Reconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=cnat1.prog-kubebuilder.info,resources=at1s,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cnat1.prog-kubebuilder.info,resources=at1s/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cnat1.prog-kubebuilder.info,resources=at1s/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the At1 object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.8.3/pkg/reconcile
func (r *At1Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	reqLogger := log.FromContext(ctx, "namesapce", req.Namespace, "at1", req.Name)

	// your logic here
	reqLogger.Info("Reconcile start ... ")

	instance := &cnat1v1alpha1.At1{}
	...
	if instance.Status.Phase == "" {
		instance.Status.Phase = cnat1v1alpha1.PhasePending
	}

	switch instance.Status.Phase {
	case cnat1v1alpha1.PhasePending:
		...
		instance.Status.Phase = cnat1v1alpha1.PhaseRunning
	case cnat1v1alpha1.PhaseRunning :
		...
		if err != nil && errors.IsNotFound(err) {
			...
			instance.Status.Phase = cnat1v1alpha1.PhaseDone
		} else {
			return ctrl.Result{}, nil
		}

	case cnat1v1alpha1.PhaseDone:
...
func newPodForCR(cr * cnat1v1alpha1.At1) * corev1.Pod {
	return &corev1.Pod{
...
func (r *At1Reconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cnat1v1alpha1.At1{}).
		Complete(r)
}
